...
class StoreQuestionRequest extends FormRequest
{
    ...
    /**
     * Apply the canonical document shape (already validated in after()) to the
     * validated payload, replacing the dot-notation-collapsed values Laravel
     * returns for nested array attributes.
     *
